...
#     """
#     Align dataframe ke dataset params TANPA mengisi unknown future variables.
#     Known future -> boleh ffill/bfill
#     Unknown future (termasuk target) -> BIARKAN NaN
#     """
...
#     fill_cols = [c for c in known_cols if c in df.columns and c != "Date"]
